...
Revision ID: 76bf68a31451
Revises: 
Create Date: 2025-03-05 08:47:24.618972
...
def upgrade() -> None:
    ...
    # This is needed because a previous migration attempt might have created them
    try:
    ...
    try:
        op.execute('DROP TYPE IF EXISTS itemspace')
    except Exception:
        pass
    ...
    # First create users table without the foreign key constraint
    ...
    # Removed foreign key constraint to workspaces
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # First drop the foreign key constraint we added separately
