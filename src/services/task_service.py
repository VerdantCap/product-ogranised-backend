...
class TaskService:
    ...
    def get_tasks_by_workspace(self, workspace_id: str, skip: int = 0, limit: int = 100) -> List[Task]:
        """
        Get all tasks for a workspace with pagination.

        Returns a list of Task objects.
        """
        return self.task_dao.get_by_workspace(workspace_id, skip, limit)

    def get_tasks_by_completion_status(self, workspace_id: str, completed: bool) -> List[Task]:
        """
        Get tasks by completion status in a workspace.

        Returns a list of Task objects.
        """
        return self.task_dao.get_by_completion_status(workspace_id, completed)

    def get_tasks_by_assignee(self, user_id: str, workspace_id: str) -> List[Task]:
        """
        Get tasks assigned to a user in a workspace.

        Returns a list of Task objects.
        """
        return self.task_dao.get_by_assignee(user_id, workspace_id)
    ...
    def get_upcoming_tasks(self, workspace_id: str, days: int = 7, limit: int = 10) -> List[Task]:
        ...
        """
        return self.task_dao.get_upcoming_tasks(workspace_id, days, limit)
    ...
    def get_overdue_tasks(self, workspace_id: str, limit: int = 10) -> List[Task]:
        ...
        Returns a list of Task objects ordered by due date.
        """
        return self.task_dao.get_overdue_tasks(workspace_id, limit)
    ...
    def create_task(self, task: Task) -> Task:
        ...
        """
        return self.task_dao.create_task(task)
    ...
    def update_task(self, task_id: str, task_data: TaskUpdate) -> Task:
        ...
        return self.task_dao.update_task(task)
    ...
    def delete_task(self, task_id: str) -> None:
        ...
        self.task_dao.delete_task(task)

    def toggle_task_completion(self, task_id: str, completed: bool) -> Task:
        """
